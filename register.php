...
<?php
	if(isset($_POST['submit_user_btn']))
	{
		...
		{
			if($fetch_rows['reg_no']==$reg && $fetch_rows['pin_no']==$pin)
			{
				$flag=true;
				break;
			}
		...
		if($flag)
		{
			$insert_Sql="INSERT INTO student_details (reg_no,username,password,phone_no) VALUES ('$reg','$user','$pass','$mob_number')";
			var_dump($insert_Sql);
